...
export function ServerList({ servers, onServerDeleted, onServerSynced, onError }: ServerListProps) {
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate mb-1">{server.wordpressUrl}</p>
              <p className="text-xs text-gray-400">
                Slug:{' '}
                <code className="bg-gray-100 px-1.5 py-0.5 rounded text-teal-600 font-medium">
                  {server.slug}
                </code>
                <span className="mx-2">|</span>
                Posts:{' '}
                <span className="text-gray-600 font-medium">{server.postCount ?? 'N/A'}</span>
              </p>
            </div>
